    ...
    return(
        <div className="min-h-screen bg-gray-950 text-white">
            ...
            <div className="flex gap-4">
                <Link to ="/login"><button className="px-4 py-2 text-gray-300 hover:text-white cursor-pointer">Login</button></Link>
                <Link to ="/signup"><button className="px-4 py-2 bg-purple-600 rounded-lg hover:bg-purple-700 cursor-pointer">Sign Up</button></Link>
            </div>
            </nav>
